...
namespace ui_imgui
{
    ...
    static inline bool init(UIState& state)
    {
    ...
    static inline void render(UIState& state)
    {
        auto& io = ImGui::GetIO();
    ...
    static inline void close(UIState& state)
    {
        // Cleanup
...
namespace ui_imgui
{
    static inline void set_window_icon(SDL_Window* window, auto const& icon_64)
    {
    ...
    static inline void handle_sdl_events(UIState& state)
    {
        SDL_Event event;
